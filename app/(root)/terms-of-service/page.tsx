...
export const metadata: Metadata = {
  ...
  description: "Read the terms of service for Onyxbulls forex trading education in Pakistan. Understand your rights and responsibilities when using our trading courses and services.",
  keywords: ["terms of service", "legal agreement", "onyxbulls terms", "forex education terms"],
  alternates: {
    ...
    <main id="main-content" className="flex min-h-screen flex-col bg-white dark:bg-black text-gray-900 dark:text-white transition-colors duration-300">
      ...
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <section className="mb-12 bg-white dark:bg-black/50 p-6 rounded-lg border border-gray-200 dark:border-gray-800">
            <h2 className="text-2xl font-semibold mb-4 text-neon-500 dark:text-neon-400">2. Use License</h2>
          ...
          <section className="mb-12 bg-white dark:bg-black/50 p-6 rounded-lg border border-gray-200 dark:border-gray-800">
            <h2 className="text-2xl font-semibold mb-4 text-neon-500 dark:text-neon-400">3. Disclaimer</h2>
            <p className="text-gray-700 dark:text-gray-300">
          ...
          <section className="mb-12 bg-white dark:bg-black/50 p-6 rounded-lg border border-gray-200 dark:border-gray-800">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              only and does not provide financial advice. Past performance is
              not indicative of future results.
            </p>
            <div className="bg-red-50 dark:bg-red-900/20 border-l-4 border-red-500 p-4 rounded">
              <p className="text-red-700 dark:text-red-400 font-medium">
                Risk Warning: Trading foreign exchange on margin carries a high level of risk,
                and may not be suitable for all investors. The possibility exists that you could
                sustain a loss of some or all of your initial investment and therefore you should
          ...
          <section className="mb-12 bg-white dark:bg-black/50 p-6 rounded-lg border border-gray-200 dark:border-gray-800">
            <h2 className="text-2xl font-semibold mb-4 text-neon-500 dark:text-neon-400">5. Limitations</h2>
            <p className="text-gray-700 dark:text-gray-300">
